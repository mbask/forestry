...
#'
#' Tree density is estimated as \eqn{N=\phi \cdot \sum_{i=1}^n{\frac{1}{g_i}}} where \eqn{\phi} is the relascopic band used during sampling, \eqn{n} is the total count of trees found to be inside of the plot.
#' 
